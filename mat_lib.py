...
SS316 = Material(density=8030, TS=580, YS=290, E=193, Charpy=105, Izod=129, resitivity=7.4e-5, magneticPermeability=1.008, specificHeatCapacity=500, k = 16.3, CTE20C = 16, CTE250C = 16.2, CTE500C = 17.5, meanMeltingPoint=1385,e_20C=.28)
